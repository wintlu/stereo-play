...
- **Channel Separation** - Split stereo audio into left/right channels
- **Synchronized Playback** - All devices stay perfectly in sync
- **YouTube Support** - Paste any YouTube URL to play
- **Track Library** - Previously played tracks are saved for quick access
- **Loop/Sequence Modes** - Loop a single track or auto-play through your library
